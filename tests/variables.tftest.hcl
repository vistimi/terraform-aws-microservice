...
run "check_rest" {
  ...
  variables {
    health_checks = [
      {
        url = "http://testttttt-1219325492.us-east-1.elb.amazonaws.com:80/"
        header = {
      ...
      {
        url = "http://testttttt-1219325492.us-east-1.elb.amazonaws.com:81/"
        header = {
          Accept = "application/json"
        }
        method                = "GET"
      ...
      {
        url = "http://testttttt.vistimi.com:80/"
        header = {
          Accept = "application/json"
        }
        method                = "GET"
      ...
      {
        url = "http://testttttt.vistimi.com:81/"
        header = {
          Accept = "application/json"
        }
        method                = "GET"
      ...
      {
        url = "https://testttttt.vistimi.com:443/"
        header = {
          Accept = "application/json"
        }
        method                = "GET"
      ...
      {
        url = "https://www.testttttt.vistimi.com:443/"
        header = {
          Accept = "application/json"
        }
        method                = "GET"
